...

{
  ...
  "properties": {
    ...
    Схема колекції: personnel_documents
Структура
{
  "_id": "ObjectId",
  "personnelId": "int",
...
Звʼязок:
personnelId → personnel.personnelId (Reference-like relation)
    ...
    JSON Schema (DDL)
{
  ...
  "properties": {
    ...
    Схема колекції: physical_examinations
Структура
{
  "_id": "ObjectId",
  "personnelId": "int",
    ...
    JSON Schema (DDL)
{
  ...
  "properties": {
    ...
    Схема колекції: work_shift_logs
Структура
{
  "_id": "ObjectId",
  "personnelId": "int",
